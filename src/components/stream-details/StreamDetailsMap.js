...
export default withScriptjs(withGoogleMap(class StreamDetailsMap extends Component {
  render() {
    const MapOptions = {
    ...
    return (
      ...
      >
        <LandingMapMarker
          ...
          position={{ lng: this.props.stream.geometry.coordinates[1], lat: this.props.stream.geometry.coordinates[0] }}
        />
      </GoogleMap>
    );
  }
