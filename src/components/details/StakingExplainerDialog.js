  ...
  render(){
    ...
    return(
      ...
      >
        ...
        <iframe width="100%" height="275" src="https://www.youtube-nocookie.com/embed/8YD__H9Nrj0?rel=0&amp;showinfo=0" frameBorder="0" allow="autoplay; encrypted-media" allowFullScreen style={{marginBottom:"12px"}} title="Staking Explainer"></iframe>
